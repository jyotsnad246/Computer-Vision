...
from sklearn.svm import LinearSVC # using this classifier
from skimage.io import imread
from itertools import chain  #iterable
from sklearn.datasets import fetch_lfw_people # human faces
from sklearn.feature_extraction.image import PatchExtractor # for negative samples
import numpy as np
import cv2
...
negative_samples = [(getattr(data, name)()) for name in non_face_topics] #getattr will concatenate data with non_face_topics like data.moon() etc...
...
test_image = imread(fname='male_face.png')
